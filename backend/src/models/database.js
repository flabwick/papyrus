...
async function checkTables() {
  try {
    const result = await query(`
      ...
      AND table_name IN ('users', 'libraries', 'pages', 'page_links', 'workspaces', 'workspace_pages', 'workspace_files', 'workspace_forms', 'files', 'forms', 'cli_sessions', 'web_sessions')
      ORDER BY table_name
    `);
    
    const existingTables = result.rows.map(row => row.table_name);
    const requiredTables = ['users', 'libraries', 'pages', 'page_links', 'workspaces', 'workspace_pages', 'workspace_files', 'workspace_forms', 'files', 'forms', 'cli_sessions', 'web_sessions'];
